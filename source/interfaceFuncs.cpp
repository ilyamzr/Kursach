...
void sellerMode(const string& logi, const string& filename)
{
    string login;
    ...
    while (choice != 4)
    {
        ...
        {
            deleteProductFunc(login);
        }
        else if (choice != 4) cout << "Неверный выбор" << endl;
    }
}

void buyermode(const string &logi, const string &filename)
{
    int choice = 0;
    string login;
    cout << "Введите логин: " << endl;
