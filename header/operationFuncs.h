...
std::vector<Product> categoriesSort(const std::string& filename, int category, int subcategory, const std::string& login);
std::vector<Product> getMyProducts(const std::string& login);
